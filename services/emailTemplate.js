                                ...
                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                    ...
                                    <tbody>
                                        ...
                                        <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                            ...
                                            <tbody>
                                                <tr>
                                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color:#B22222; border-radius: 5px; text-align: center;"> <a href="${downloadLink}" target="_blank" style="display: inline-block; color: #ffffff; background-color: #B22222; border: solid 1px #B22222; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #B22222;">Download file</a> </td>
                                                </tr>
                                            </tbody>
                                            </table>
                                        </td>
                                    ...
                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Do give it a try.</p>
                                </td>
                                </tr>
                            </table>
                            </td>
